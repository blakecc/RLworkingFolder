...
if resume:
    ...
    kmodel.load_weights('save_k_03b.h5')
    game_history = pickle.load(open('game_history_k_03_b2.p', 'rb'))
...
while True:
  ...
  if done: # an episode finished
    ...
    episode_number += 1
    pickle.dump(game_history, open('game_history_k_03_b2.p', 'wb'))
    ...
    if episode_number % 100 == 0: kmodel.save_weights('save_k_03b.h5')
    reward_sum = 0
