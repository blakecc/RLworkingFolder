...
if resume:
    model = pickle.load(open('save_new.p', 'rb'))
    game_history = pickle.load(open('game_history_new.p', 'rb'))
...
while True:
  ...
  if done: # an episode finished
    ...
    episode_number += 1
    pickle.dump(game_history, open('game_history_new.p', 'wb'))
    ...
    if episode_number % 100 == 0: pickle.dump(model, open('save_new.p', 'wb'))
    reward_sum = 0
