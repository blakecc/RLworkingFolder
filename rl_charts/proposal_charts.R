...
game_history <- read_feather("../Histories/game_history_k_conv_3_LR2e5_ClipNorm.feather")
...
gh_plot <- game_history %>%
  ggplot() +
    ...
    ggtitle("History: Conv, LR 2e-05, Clipnorm") +
    xlab("Episode number") +
    ylab("Episode net score") +
    scale_colour_discrete(name = "Legend") +
    theme_light()

ggsave(filename = "figs/game_history_k_conv_3_LR2e5_ClipNorm.png", plot = gh_plot, device = "png"
       # , units = "mm",
       # width = 100,
       # height = 50
       )
