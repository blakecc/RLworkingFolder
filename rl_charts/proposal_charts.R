...
game_history <- read_feather("../game_history_k_02.feather")
...
gh_plot <- game_history %>%
  ggplot() +
    ...
    ggtitle("Game episode history for Pong reinforcement learning agent") +
    xlab("Episode number") +
    ylab("Episode net score") +
    scale_colour_discrete(name = "Legend") +
    theme_light()

ggsave(filename = "figs/gh_plot_02.png", plot = gh_plot, device = "png"
       # , units = "mm",
       # width = 100,
       # height = 50
       )
